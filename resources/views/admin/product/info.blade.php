...
@section('content')
    ...
    <form class="form form-horizontal" action="" method="post">
        ...
        <div class="row cl">
            <label class="form-label col-sm-3"><span class="c-red"></span>简介：</label>
            <div class="formControls col-sm-5">
                {{$product->summary}}
            </div>
            <div class="col-sm-4"></div>
        ...
        <div class="row cl">
            <label class="form-label col-sm-3"><span class="c-red"></span>类别：</label>
            <div class="formControls col-sm-5">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-sm-5">
                @if($product->preview != null)
                    <img id="preview_id" src="{{$product->preview}}"
                         style="border: 1px solid #B8B9B9; width: 100px; height: 100px;"/>
                @endif
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-sm-3">详细内容：</label>
            <div class="formControls col-sm-8">
                {{$pdt_content->content}}
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-sm-3">产品图片：</label>
            <div class="formControls col-sm-8">
                @foreach($pdt_images as $pdt_image)
                    <img src="{{$pdt_image->image_path}}"
                         style="border: 1px solid #B8B9B9; width: 100px; height: 100px;"/>
                @endforeach
            </div>
        </div>
